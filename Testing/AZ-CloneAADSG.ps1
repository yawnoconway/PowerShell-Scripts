...
$oldGroupId = "<SOURCE_GROUP_OBJECT_ID>" # The ObjectId of the group to clone
$newGroupName = "Cloned-SecurityGroup"
$newGroupDesc = "This is a cloned security group"
$newGroupMailNick = "ClonedSecurityGroup" # Must be unique in the tenant
