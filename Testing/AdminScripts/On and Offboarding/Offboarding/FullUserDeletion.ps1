...
$banner = @'
  ...
  / /   / / __/ _ \/ ___/ __ `/                                                        
 / /___/ / /_/  __/ /  / /_/ /                                                         
/_____/_/\__/\___/_/   \__,_/__       __     __  _                     ___ 
  / / / /_______  _____   / __ \___  / /__  / /_(_)___  ____          <  /  ___
 / / / / ___/ _ \/ ___/  / / / / _ \/ / _ \/ __/ / __ \/ __ \    _  _ / /  / _ \
/ /_/ (__  )  __/ /     / /_/ /  __/ /  __/ /_/ / /_/ / / / /   | |/ / /_ / // / 
\____/____/\___/_/     /_____/\___/_/\___/\__/_/\____/_/ /_/    |___/_/(_)\___/  
...
while ($DeletionComplete -eq $False) {
    try {
        ...
        switch ($answer) {
            "Single" {                
                # Randomly Select the First Correct Answer
                ...
                if ($confirmationResponse -eq $Affirmative01) {
                    # User Provided the Correct Answer, Proceed to Ask Next Question

                    # Randomly Select a New Answer for the Second Question
                    $Affirmative02 = ($yesanswers | Where-Object { $_ -ne $Affirmative01 }) | Get-Random

                    # Ask "Are you absolutely sure?"
                    ...
                    if ($confirmationResponse -eq $Affirmative02) {
                        ...
                        # Randomly Select a New Answer for the Third Question
                        ...
                        if ($confirmationResponse -eq $Affirmative03) {
                            # User Provided the Correct Answer, Proceed Accordingly
                            ...
                            if (($mailbox)) {
                                ...
                                Write-Host "The mailbox doesn't exist for the user: $Username. Skipping mailbox conversion..."
                            }
                            ...
                            if (($mguser)) {
                                ...
                                Write-Host "User $UserMail not found in 365 Admin"
                                $confirmationResponse = Read-Host "Would you like to continue with deleting the AD user $UserMail anyway? (Yes/No)"
                                if ($confirmationResponse -in $noanswers) {
                                    # User Wants to Exit Script
                                    continue
                                }    
                                elseif ($confirmationResponse -notin $yesanswers) {
                                    # User Didn't Confirm with the Correct Answer, go into infinite loop
                                    ShowNedry
                                }
                            }

                            # Delete User's Account in Active Directory
